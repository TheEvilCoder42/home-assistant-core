...
# and the audio delay (DELAY), "SP" for the speaker preset (SPPR).
# Used by __init__.py to notify that coordinator independently of
# whether the media_player entity is enabled.
